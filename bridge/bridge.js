...
+ '<body><div class="card"><div class="brand"><span class="glyph">F</span><span>Flimify <small style="color:#7c7d87">for Premiere Pro</small></span></div><div id="view"><p class="sub">Loading…</p></div></div>'
+ '<script type="module">'
